...
let torontoData = "https://raw.githubusercontent.com/SEngel23/Mapping_Earthquakes/main/torontoRoutes.json";

// Create style for lines on Map
let myStyle = {
  color: "yellow",
  weight: 2
}
...
// d3.json(torontoData).then(function(data) {
//     console.log(data);
//     // Creating the JSON layer with retrieved data
//   L.geoJSON(data, {
//     onEachFeature: function(feature, layer) {
//     console.log(data);
